...
int main()
{
	int a[20][20],i,j,k,l,x;
	for(i=0;i<20;i++)
	{
		scanf("%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d",&a[i][0],&a[i][1],&a[i][2],&a[i][3],&a[i][4],&a[i][5],&a[i][6],&a[i][7],&a[i][8],&a[i][9],&a[i][10],&a[i][11],&a[i][12],&a[i][13],&a[i][14],&a[i][15],&a[i][16],&a[i][17],&a[i][18],&a[i][19]);
	}
	unsigned long long int m=0,p;
	for(i=0;i<20;i++)
	{
		for(j=0;j<17;j++)
		{
